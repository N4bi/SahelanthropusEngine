...
{
	transform.Scale(x, y, z); // idk if its this method 
}
...
// LINE ==================================================
Line_Prim::Line_Prim() : Primitive(), origin(0, 0, 0), destination(1, 1, 1)
{
	type = PrimitiveTypes::Primitive_Line;
}

Line_Prim::Line_Prim(float x, float y, float z) : Primitive(), origin(0, 0, 0), destination(x, y, z)
{
	type = PrimitiveTypes::Primitive_Line;
}

void Line_Prim::InnerRender() const
{
	glLineWidth(2.0f);
